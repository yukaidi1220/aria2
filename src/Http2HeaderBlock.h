 ...
 */
/* copyright --> */
#ifndef D_HTTP2_HEADER_BLOCK_H
#define D_HTTP2_HEADER_BLOCK_H
...
struct Http2Header {
  ...
  Http2Header(std::string name, std::string value);
};

typedef std::vector<Http2Header> Http2HeaderBlock;
